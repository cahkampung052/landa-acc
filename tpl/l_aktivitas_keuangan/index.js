app.controller('l_aktivitaskeuanganCtrl', function($scope, Data, $rootScope, $uibModal, $state) {
    var control_link = "acc/l_aktivitas_keuangan";
    $scope.form = {};
    $scope.url = {};
    ...
    $scope.view = function (is_export, is_print) {
        ...
        if (is_export == 0 && is_print == 0) {
            ...
            Data.get('site/base_url').then(function (response) {
                window.open(response.data.base_url + "api/acc/l_aktivitas_keuangan/laporan?" + $.param(param), "_blank");
            });
