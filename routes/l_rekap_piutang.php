...
//    print_r($params);die();
    ...
    if (isset($params['m_akun_id']) && isset($params['m_lokasi_id'])) {
        ...
        foreach($supplier as $key => $val){
           ...
           $getsaldopiutang = $sql->find();
           
           /*
            * isi debit kredit di detail
            */
           $arr[$key]["debit"] = ($getsaldopiutang->debit != NULL) ? $getsaldopiutang->debit : 0;
           $arr[$key]["kredit"] = ($getsaldopiutang->kredit != NULL) ? $getsaldopiutang->kredit : 0;
